...
return [
    ...
    'notes'                                  => 'Σημειώσεις',
    'image_server_ip'                        => 'IP διακομιστή',
    'image_server_path_prefix'               => 'Πρόθεμα διαδρομής διακομιστή',
    'edit'                                   => 'Επεξεργασία',
    ...
    'enter_minutes'                          => 'Λεπτά από τελευταία εκκίνηση',
    'hi'                                     => 'Γεια',
    'status'                                 => 'Κατάσταση',
    'verified'                               => 'Επιβεβαιωμένο',
    'not_verified'                           => 'Μη Επιβεβαιωμένο',
    'resend_confirmation_email'              => 'Επαναποστολή Email Επιβεβαίωσης',
