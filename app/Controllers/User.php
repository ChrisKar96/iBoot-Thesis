        ...
        return view(
            ...
            [
                ...
                'columns'   => '{title:"' . lang('Text.fullname') . '", field:"name", sorter:"string", editor:"input", validator:["required","string","maxLength:40"]},
                                {title:"' . lang('Text.email') . '", field:"email", sorter:"string", editor:"input", validator:["required","unique","string","maxLength:320"]},
                                {title:"' . lang('Text.phone') . '", field:"phone", sorter:"string", editor:"input", validator:["string","maxLength:15"]},
                                {title:"' . lang('Text.username') . '", field:"username", sorter:"string", editor:"input", validator:["required","unique","string","minLength:3","maxLength:40"]},
