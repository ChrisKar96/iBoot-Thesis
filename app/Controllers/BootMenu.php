    ...
    public function index()
    {
        return view(
            ...
            [
                ...
                'columns'   => '{title:"' . lang('Text.boot_menu') . '", field:"name", sorter:"string", editor:"input", headerFilter:"input", validator:["required", "maxLength:20"], frozen:true},
                                {title:"' . lang('Text.description') . '", field:"description", sorter:"string", editor:"input", headerFilter:"input", validator:["required", "maxLength:50"]},
                                {title:"' . lang('Text.ipxe_block') . '", field:"ipxe_block", sorter:"string", headerFilter:"input", editor:"textarea"},
